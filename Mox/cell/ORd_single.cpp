...
int main () {
    ...
    const char *fromSingle = "SingleState1Hz_Mox2.beat2000";
    double vmax = 0;
...
double Calcu_I_Total(Cell *theCell, double dt, double I_inj){
    ...
    double bid_zw = 0*bi; // NO inactivation
    
    double bi_d = 0*bi ; // NO inactivation
    
    double bid = 0*bi ; // NO inactivation
